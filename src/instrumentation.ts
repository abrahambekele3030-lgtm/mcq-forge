 ...
 *
 * Runs once when the server starts (before any request). Responsibilities:
...
export async function register() {
  ...
  // In production (Docker), the Dockerfile already runs db-setup.sh before
  // `next start`, so this is a belt-and-suspenders safety net.
